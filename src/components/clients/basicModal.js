...
export default function BasicModal(props) {
  ...
  const onSubmitHandler = () => {
    axios.post("https://comcalc-server.herokuapp.com/client/edit/client", {"address": address, "id": props.client.id, "end_date": endDate, "start_date": startDate, "sessions_remaining": sessionsRemaining})
      .then((result) => {
        console.log(result);
        setAddress("");
        setEndDate("");
